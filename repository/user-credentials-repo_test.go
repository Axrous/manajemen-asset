...
////	expectedArgs := []driver.Value{userDetails.ID, userDetails.Name, userDetails.PhoneNumber, userDetails.Address, userDetails.Email, userDetails.BirthDate, userDetails.ImgUrl}
////
