...
func (u *userDetailsRepository) CreateNewUserDetails(udetails model.UserDetails) error {
	...
	query := "insert into user_details (id,user_id,name,phone_number,address,email,birth_date,img_url) values ($1, $2, $3, $4, $5, $6, $7, $8)"
	_, err := u.db.Exec(query, udetails.ID, udetails.ID, udetails.Name, udetails.PhoneNumber, udetails.Address, udetails.Email, udetails.BirthDate, udetails.ImgUrl)
	if err != nil {
